...
func LoadAdmin(u *gotgbot.Updater) {
	...
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("unpin", noodlex.BotConfig.Prefix, unpin))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("invitelink", noodlex.BotConfig.Prefix, invitelink))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("adminlist", noodlex.BotConfig.Prefix, adminlist))
}
