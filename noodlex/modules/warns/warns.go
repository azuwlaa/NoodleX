...
func LoadWarns(u *gotgbot.Updater) {
	defer log.Println("Loaded module: warns")
	u.Dispatcher.AddHandler(handlers.NewPrefixArgsCommand("warn", noodlex.BotConfig.Prefix, warnUser))
	u.Dispatcher.AddHandler(handlers.NewCallback("rmWarn", button))
	u.Dispatcher.AddHandler(handlers.NewPrefixArgsCommand("resetwarns", noodlex.BotConfig.Prefix, resetWarns))
	u.Dispatcher.AddHandler(handlers.NewPrefixArgsCommand("warns", noodlex.BotConfig.Prefix, warns))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("addwarn", noodlex.BotConfig.Prefix, addWarnFilter))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("nowarn", noodlex.BotConfig.Prefix, removeWarnFilter))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("rmwarn", noodlex.BotConfig.Prefix, removeWarnFilter)) // Just an alias for nowarn
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("warnlist", noodlex.BotConfig.Prefix, listWarnFilters))
	u.Dispatcher.AddHandler(handlers.NewPrefixArgsCommand("warnlimit", noodlex.BotConfig.Prefix, setWarnLimit))
	u.Dispatcher.AddHandler(handlers.NewPrefixArgsCommand("strongwarn", noodlex.BotConfig.Prefix, setWarnStrength))
