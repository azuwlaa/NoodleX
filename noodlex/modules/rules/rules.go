...
func LoadRules(u *gotgbot.Updater) {
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("rules", noodlex.BotConfig.Prefix, sendRules))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("setrules", noodlex.BotConfig.Prefix, setRules))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("clearrules", noodlex.BotConfig.Prefix, clearRules))
}
