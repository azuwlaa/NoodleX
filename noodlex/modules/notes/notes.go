...
func LoadNotes(u *gotgbot.Updater) {
	defer log.Println("Loaded module: notes")
	u.Dispatcher.AddHandler(handlers.NewPrefixArgsCommand("get", noodlex.BotConfig.Prefix, cmdGet))
	u.Dispatcher.AddHandler(handlers.NewRegex(`^#[^\s]+`, hashGet))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("save", noodlex.BotConfig.Prefix, save))
	u.Dispatcher.AddHandler(handlers.NewPrefixArgsCommand("clear", noodlex.BotConfig.Prefix, clear))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("notes", noodlex.BotConfig.Prefix, listNotes))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("saved", noodlex.BotConfig.Prefix, listNotes))
}
