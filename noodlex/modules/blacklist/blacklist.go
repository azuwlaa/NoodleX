...
func LoadBlacklist(u *gotgbot.Updater) {
	defer log.Println("Loaded module: blacklist")
	u.Dispatcher.AddHandler(handlers.NewPrefixArgsCommand("blacklist", noodlex.BotConfig.Prefix, blacklist))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("addblacklist", noodlex.BotConfig.Prefix, addBlacklist))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("rmblacklist", noodlex.BotConfig.Prefix, unblacklist))
	u.Dispatcher.AddHandler(handlers.NewPrefixCommand("unblacklist", noodlex.BotConfig.Prefix, unblacklist))
